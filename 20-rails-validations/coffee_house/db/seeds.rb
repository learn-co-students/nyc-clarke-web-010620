...
# --------- CREATE HERO DRINKs -------------------
puts "Creating Super Hero Coffees..."
...
100.times do   
  Order.create(size: size.sample, price: rand(10), user_id: User.all.sample.id, drink_id: Drink.all.sample.id )
end