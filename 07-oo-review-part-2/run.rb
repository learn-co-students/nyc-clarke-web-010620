...
# r8 = Role.new("Mr. T", a4, m4, 17868)

thief1 = Thief.new("Anderson Dawes", "Purple Fox", 7.9)
thief2 = Thief.new("Rachel McGraw", "Silver", 9.4)
thief3 = Thief.new("Katherine Ableton", "Grey Monkey", 8.5)
